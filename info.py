...
API_ID = int(environ['API_ID', '20460783'])
API_HASH = environ['API_HASH', '27690d11f85c3ce6bfbb76dec19f0e50']
BOT_TOKEN = environ['BOT_TOKEN', '7745813306:AAHYtxcESg1hS0Vp-yC7JWMYToHf6D3pWLw']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002376913542').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002262847876').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002262847876')
auth_grp = environ.get('AUTH_GROUP', '-1002262847876')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1004661350441')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1004664118017')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://telugugangadhar3211:Tcf96qaI083cNTvq@project1.fbjxi.mongodb.net/?retryWrites=true&w=majority&appName=Project1")
DATABASE_NAME = environ.get('DATABASE_NAME', "Project1")
